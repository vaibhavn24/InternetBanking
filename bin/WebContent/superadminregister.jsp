...
<script type="text/javascript" src="validation.js"></script>
<jsp:include page="register_outside_header.jsp"></jsp:include>
<body>
	<h1 style="text-align: center;">
		<b><i><u>Register Here</u></i></b>
		<hr>
	</h1>
	<form action="register" method="post" onsubmit="return registerform(this);">
		<table class="table50" align='left'>
				<tr>
					<th colspan=2>Personal Information</th>
			...
			<tr>
					<td>AadharCard</td>
					<td>
						<input type="text" name="aadharcard"  placeholder="AadharCard"
				...
				<tr>
					<td>PanCard</td>
					<td>
						<input type="text" name="pancard"  placeholder="PanCard"
							size=15 maxlength=12  title="max. 12 numbers">
					</td>
				</tr>
				...
				<tr>
					...
					<td width=70%>
						<input type="password" name="password" placeholder="Password"
							size=20 maxlength=20  title="max. 20 characters">
						&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr>
				...
				<!-- <tr>
					<td>Upload your passport size photo here</td>
					<td><input type="file" name="image" size="20"/><br /></td>
				</tr>  -->
			...
			<table  class="table50" align='right'>	
				...
				<tr>
					<td width=30%>line1</td>
					<td width=70%>
						<input type="text" name="localline1" placeholder="line1"
				...
				<tr>
					<td width=30%>line2</td>
					<td width=70%>
						<input type="text" name="localline2" placeholder="line2"
							size=25 maxlength=45  title="max. 45 characters">
						&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr>
					<td width=30%>City</td>
					<td width=70%>
						<input type="text" name="localcity" placeholder="City"
							size=25 maxlength=45  title="max. 45 characters">
						&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr>
					<td width=30%>Pincode</td>
					<td width=70%>
						<input type="text" name="localpincode" placeholder="Pincode"
				...
				<tr>
					<td width=30%>State</td>
					<td width=70%>
						<input type="text" name="localstate" placeholder="State"
							size=25 maxlength=45  title="max. 45 characters">
						&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr>
					<td width=30%>Country</td>
					<td width=70%>
						<input type="text" name="localcountry" placeholder="Country"
							size=25 maxlength=45  title="max. 45 characters">
			...
			<table class="table50" align='right'>
				...
				<tr>
					<td width=30%>line1</td>
					<td width=70%>
						<input type="text" name="permanantline1" placeholder="line1"
							size=25 maxlength=45  title="max. 45 characters">
						&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr>
					<td width=30%>line2</td>
					<td width=70%>
						<input type="text" name="permanantline2" placeholder="line2"
							size=25 maxlength=45  title="max. 45 characters">
						&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr>
					<td width=30%>City</td>
					<td width=70%>
						<input type="text" name="permanantcity" placeholder="City"
							size=25 maxlength=45  title="max. 45 characters">
						&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr>
					<td width=30%>Pincode</td>
					<td width=70%>
						<input type="text" name="permanantpincode" placeholder="Pincode"
							size=15 maxlength=6  title="max. 6 characters">
						&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr>
					<td width=30%>State</td>
					<td width=70%>
						<input type="text" name="permanantstate" placeholder="State"
							size=25 maxlength=45  title="max. 45 characters">
						&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr>
					<td width=30%>Country</td>
					<td width=70%>
						<input type="text" name="permanantcountry" placeholder="Country"
							size=25 maxlength=45  title="max. 45 characters">
						&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
