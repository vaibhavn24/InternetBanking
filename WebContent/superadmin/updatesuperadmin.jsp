	...
	<div id="container">
		<div id="content-container">
			...
			%> <input type="text" name="gender" disabled="disabled"
					...
					<tr>
						...
						<td><input type="text" name="email" placeholder="Email"
							id="email" value="<%=admin.getEmail()%>" size=25 maxlength=30
					...
					<tr>
						...
						<td><input type="text" name="primaryPhoneNumber"
							...
							value="<%=admin.getPrimaryPhoneNumber()%>" size=10 maxlength=10
					...
					<tr>
						...
						<td><input type="text" name="secondaryPhoneNumber"
							...
							value="<%=admin.getSecondaryPhoneNumber()%>" size=10 maxlength=10
							class="NumTextBox" title="max. 10 numbers" /></td>
					<tr>
					<tr>
						<td>Date-Of-Birth</td>
						<td><input type="date" name="dateOfBirth"
							placeholder="yyyy/mm/dd" value="<%=admin.getDateOfBirth()%>" />
						</td>
					</tr>
					<tr>
						<td>AadharCard</td>
						<td><input type="text" name="aadharcard"
							placeholder="AadharCard" value="<%=admin.getAadharcard()%>"
							size=15 maxlength=12 title="max. 12 numbers" /></td>
					</tr>
					<tr>
						<td>PanCard</td>
						<td><input type="text" name="pancard" placeholder="PanCard"
							value="<%=admin.getPancard()%>" size=15 maxlength=12
			...
			%> <input type="text" name="residentialstatus" disabled="disabled"
					...
					<tr>
						...
						<td width=70%><input type="text" name="userName"
							...
							value="<%=admin.getUserName()%>" size=15 maxlength=30
			...
			%> <input type="text" name="userType" disabled="disabled"
							...
							name="userType1" value="<%=admin.getUserType()%>" /></td>
			...
			%>
				...
				%>
					...
					<tr>
						...
						<td width=70%><input type="text" name="permanantcity"
							placeholder="City" value="<%=permanantaddress.getCity() %>"
							size=25 maxlength=45 title="max. 45 characters" />
							&nbsp;&nbsp;&nbsp;</td>
					</tr>
					<tr>
				...
				<jsp:include page="simplecaptcha.jsp"></jsp:include>
					...
					<tr>
						...
						<td width=70%><input type="file" name="image" size="20"
							value="<%=admin.getImage()%>" /></td>
				...
				<table class="table100" align="center">
					<tr>
						<td colspan="2" align='center'><input type="hidden"
							name="updateEmpId" value=<%=request.getParameter("ilRecId")%> />
