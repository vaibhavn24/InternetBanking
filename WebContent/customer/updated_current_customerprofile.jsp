...
<body>
	...
	<form action="updatecurrent_custprofile" method="post"
		...
		<table class="table50" align='left'>
			...
			<tr>
				...
				<td width=70%><input type="text" name="firstName"
					value="<%=customer.getFirstName()%>" placeholder="First Name"
					size=25 maxlength=30 title="max. 30 characters" /></td>
			</tr>
			<tr>
				<td width=30%>Last Name</td>
				<td width=70%><input type="text" name="lastName"
					value="<%=customer.getLastName()%>" placeholder="Last Name" size=25
					maxlength=30 title="max. 30 characters" /></td>
			</tr>
			<tr>
				<td width=30%>Mother Name</td>
				<td width=70%><input type="text" name="motherName"
					value="<%=customer.getMotherName()%>" placeholder="Mother Name"
			...
			<tr>
				...
				<td><input type="text" name="email" placeholder="Email"
					id="email" value="<%=customer.getEmail()%>" size=25 maxlength=30
			...
			<tr>
				...
				<td><input type="text" name="primaryPhoneNumber"
					...
					value="<%=customer.getPrimaryPhoneNumber()%>" size=10 maxlength=10
			...
			<tr>
				...
				<td><input type="text" name="secondaryPhoneNumber"
					...
					value="<%=customer.getSecondaryPhoneNumber()%>" size=10
					maxlength=10 class="NumTextBox" title="max. 10 numbers" /></td>
			<tr>
			<tr>
				<td>Date-Of-Birth</td>
				<td><input type="date" name="dateOfBirth"
					placeholder="yyyy/mm/dd" value="<%=customer.getDateOfBirth()%>" />
				</td>
			</tr>
			<tr>
				<td>AadharCard</td>
				<td><input type="text" name="aadharcard"
					placeholder="AadharCard" value="<%=customer.getAadharcard()%>"
					size=15 maxlength=12 title="max. 12 numbers" /></td>
			</tr>
			<tr>
				<td>PanCard</td>
				<td><input type="text" name="pancard" placeholder="PanCard"
					value="<%=customer.getPancard()%>" size=15 maxlength=12
			...
			<tr>
				...
				<td width=70%><input type="text" name="userName"
					...
					value="<%=customer.getUserName()%>" size=15 maxlength=30
			...
			%> <input type="text" name="userType" disabled="disabled"
					...
					name="userType1" value="<%=customer.getUserType()%>" /></td>
		...
		<table class="table50" align='right'>
			...
			<tr>
				...
				<td width=70%><input type="text" name="localline1"
					...
					maxlength=45 title="max. 45 characters" /> &nbsp;&nbsp;&nbsp;
				</td>
			</tr>
			<tr>
		...
		<table class="tabl100" align='left'>
			<tr>
				<td colspan="2" align='center'><input type="hidden"
					name="updateEmpId"
					value=<%=Integer.parseInt(request.getParameter("id"))%>> <input
