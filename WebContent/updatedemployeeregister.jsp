	 ...
	 <!--   --> 
		<table class="table50" align='left'>
			...
			<tr>
				...
				<td width=70%><input type="text" name="firstName" value="<%=emp.getFirstName()%>"
					placeholder="First Name" size=25 maxlength=30
					title="max. 30 characters"></td>
			</tr>
			<tr>
				<td width=30%>Last Name</td>
				<td width=70%><input type="text" name="lastName" value="<%=emp.getLastName()%>"
					placeholder="Last Name" size=25 maxlength=30
					title="max. 30 characters"></td>
			</tr>
			<tr>
				<td width=30%>Mother Name</td>
				<td width=70%><input type="text" name="motherName" value="<%=emp.getMotherName()%>"
			...
			<tr>
					<td>Email</td>
					<td>
						<input type="text" name="email" placeholder="Email" id="email" value="<%=emp.getEmail()%>"
			...
			<tr>
					...
					<td>
						<input type="text" name="primaryPhoneNumber"  placeholder="PrimaryPhoneNumber" value="<%=emp.getPrimaryPhoneNumber()%>"
			...
			<tr>
					...
					<td>
						<input type="text" name="secondaryPhoneNumber" placeholder="SecondaryPhoneNumber" value="<%=emp.getSecondaryPhoneNumber()%>"
							size=10 maxlength=10 class="NumTextBox" title="max. 10 numbers">
					</td>			
			<tr>
			<tr>
					<td>Date-Of-Birth</td>
					<td>
						<input type="date" name ="dateOfBirth"  placeholder="yyyy/mm/dd"  value="<%=emp.getDateOfBirth()%>">
					</td>
			</tr>
			<tr>
					<td>AadharCard</td>
					<td>
						<input type="text" name="aadharcard"  placeholder="AadharCard" value="<%=emp.getAadharcard()%>"
				...
				<tr>
					<td>PanCard</td>
					<td>
						<input type="text" name="pancard"  placeholder="PanCard" value="<%=emp.getPancard()%>"
							size=15 maxlength=12  title="max. 12 numbers">
					</td>
				</tr>
			...
			%>
				...
				<tr>
					...
					<td width=70%>
						<input type="text" name="userName" placeholder="User Name" id="username" value="<%=emp.getUserName()%>"
			...
			%>	
					...
					&nbsp;&nbsp;&nbsp;
					<input type="hidden" name="userType1"  value="<%=emp.getUserType()%>">
					</td>
