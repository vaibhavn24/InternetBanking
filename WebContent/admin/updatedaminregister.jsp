		...
		<table class="table50" align='left'>
			...
			<tr>
				...
				<td width=70%><input type="text" name="firstName"
					value="<%=admin.getFirstName()%>" placeholder="First Name" size=25
			...
			<tr>
				...
				<td><input type="date" name="dateOfBirth"
					placeholder="yyyy/mm/dd" value="<%=admin.getDateOfBirth()%>" /></td>
			</tr>
			<tr>
				<td>AadharCard</td>
				<td><input type="text" name="aadharcard"
					placeholder="AadharCard" value="<%=admin.getAadharcard()%>" size=15
